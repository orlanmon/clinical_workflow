...
namespace clinicalworkflow.web.services.webapi
{
    public class Startup
    {
        public Startup(IConfiguration configuration)
        {
            ...
            // Call AutoMapper Configuration Once Here 
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "clinicalworkflow.web.services.webapi", Version = "v1" });
            });
        }
